...
def select_feature(update: Update, context: CallbackContext) -> str:
    ...
    buttons = [
        [
            InlineKeyboardButton(text='Name', callback_data=str(CAPITAL)),
...
def ask_for_input(update: Update, context: CallbackContext) -> str:
    ...
    print("CURRENT_FEATURE: " + (context.user_data[CURRENT_FEATURE]))
...
def save_input(update: Update, context: CallbackContext) -> str:
    ...
    user_data = context.user_data
    print("save_input - CURRENT_FEATURE: " + str(user_data[CURRENT_FEATURE]))

    user_data[FEATURES][user_data[CURRENT_FEATURE]] = update.message.text

    print(user_data[FEATURES])
    user_data[START_OVER] = True
...
def main() -> None:
    ...
    updater = Updater("5271074358:AAGNG-tWRytCgqeSFLFWzkImZGcvzFGRv7Q")
